...
<body class="h-100 pb-5">
  ...
  <li class="nav-item">
    ...
    <div class="d-flex">
      ...
      <a class="btn btn-warning text-light" type="submit" style="margin-right: 20px;" href="registration.php">Sign Up</a>
    </div>
  </div>
</nav>
...
<div class="container mt-5">
  <div class="d-flex justify-content-center">
    <div class="align-items-center">
        ...
        <div class="container border border-warning border-3 p-5 rounded text-end" style="background-color: rgba(255, 255, 255, 0.2); width: 400px;">
          <form>
            <h2 class="mb-5 text-center text-warning">LOGIN</h2>
            <div class="row mb-3">
              <div class="col">
